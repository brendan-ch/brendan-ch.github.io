...
[Tri Vu](https://www.linkedin.com/in/tri-q-vu/) built a web interface prototype
and Python-based backend utilizing the Gemini Vision API and Fish Audio for TTS.

I built a native proof-of-concept using SwiftUI, AVFoundation, and other native
